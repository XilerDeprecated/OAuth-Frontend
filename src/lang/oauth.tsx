...
export const lang: OAuthLang = {
  ...
  fr: {
    ...
    permissions: [
      {
        id: 1,
        description: "Accédez à votre adresse électronique",
      },
      {
        id: 2,
        description: "Accédez à vos connexions tierces",
      },
    ],
  },
  ...
  nl: {
    ...
    permissions: [
      {
        id: 1,
        description: "Toegang tot uw e-mail adres",
      },
      {
        id: 2,
        description: "Toegang tot uw aansluitingen van derden",
      },
    ],
  },
};
